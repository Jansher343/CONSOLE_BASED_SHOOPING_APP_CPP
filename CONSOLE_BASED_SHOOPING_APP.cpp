...
public:
    user()
    {
        ...
        while (true)
        {
            ...
            {
                cout << "Incorrect,Make sure its 8 digit !" << endl;
            }
        }
    }
    bool login()
...
int buyerUserInterference(cart &cartObj, ProductManagment &pm1)
{
    ...
    while (true)
    {
        ...
        {
        case '1':
            cout << endl<< "Enter 1 to Add a Furniture." << endl;
        ...
        case '2':
            ...
            break;
        case '3':
            cout << endl<< "Enter 1 to View all Furniture." << endl;
...
int sellerUserInterferance(ProductManagment &pm1)
{
    ...
    while (true)
    {
        ...
        cout << endl<< "Enter 1 Add a Product to Selling List" << endl;
